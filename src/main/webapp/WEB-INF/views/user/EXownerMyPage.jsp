...
<%--&lt;%&ndash;<c:import url="/WEB-INF/views/layout/header.jsp"/>&ndash;%&gt;--%>
<%--<!doctype html>--%>
<%--<html lang="en">--%>
<%--<head>--%>
<%--  <meta charset="UTF-8">--%>
...
<%--<input type="button" value="회원정보 수정" onclick="location.href=''"> -> userMyPage와 연결됨<br><br>--%>
<%--<input type="button" value="회원탈퇴"> -> userMyPage와 연결됨<br><br>--%>
