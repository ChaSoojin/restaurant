                ...
                <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active in" id="tabs-1-1">
                            ...
                            <h3>${user_id}사장님 안녕하세요 :)</h3>
                            <br><br>
                            <input type="button" value="내 가게 등록하기" onclick="shopCnt(${size})">
                            <br><br>

                            <c:choose>
                                <c:when test="${size eq 0}">
                                    <h3>등록된 가게가 없습니다. <br>추가해주세요! -> <input type="button" value="내 가게 등록하기" onclick="shopCnt(${size})" ></h3>
                                </c:when>
                                <c:otherwise>
                                    <div class="container">
