...
<%--</head>--%>
<%--<body>--%>
<%--&lt;%&ndash;<form method="post" action="/setMyRestaurant">&ndash;%&gt;--%>
...
<%--    </tr>--%>
<%--</table>--%>
<%--&lt;%&ndash;    <input type="hidden" name="restaurant_id" value="${restaurantList.get(0).getRestaurant_id()}">&ndash;%&gt;--%>
...
<%--&lt;%&ndash;    <script src="script/reserveValidation.js"></script>&ndash;%&gt;--%>
<%--&lt;%&ndash;</form>&ndash;%&gt;--%>
<%--</body>--%>
<%--</html>--%>